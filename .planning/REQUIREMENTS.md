...
- [x] **DATA-01**: 시스템이 Google Sheets 3개 시트(A반, B반, C반)에서 성적 데이터를 페칭할 수 있다
...
- [x] **DATA-04**: Google Sheets 연결 실패 시 시스템이 목 데이터로 폴백하며, 목 데이터임을 명확히 표시한다
...
*Last updated: 2026-02-23 — LO-01, LO-02 완료 (03-01-PLAN.md 실행)*
